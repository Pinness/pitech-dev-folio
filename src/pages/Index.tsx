...
const Portfolio = () => {
  ...
  const skills = {
    technical: [
      ...
      'Firebase', 'PostgreSQL', 'Redis', 'REST APIs', 'JWT Auth', 'Git', 
      'CI/CD', 'Unit Testing', 'Agile'
    ],
    professional: [
      'Analytic Thinking', 'Adaptability', 'Team Collaboration', 
      'Attention to Detail', 'User-Centric Mindset', 'Problem Solving'
    ]
  };
...
'
    },
    {
      ...
      highlights: ['Secure Authentication', 'REST APIs', 'Financial Data Management', 'Documentation'],
      description: 'Built user authentication (JWT), robust backend logic, and comprehensive API documentation. Enabled real-time analytics, currency updates, and seamless frontend-backend integration.'
    },
    {
      id: 3,
      title: 'JechSpace',
  ...
  const experience = [
    {
      ...
      description: 'JWT authentication, RBAC implementation, Twilio integration, booking logic optimization, and Agile sprint collaboration.',
    ...
    },
    {
      ...
      location: 'Remote',
      period: 'Jul – Aug 2024',
      description: 'Flask application development, SQLAlchemy integration, gamified quiz system design, modular architecture, and inclusive UX implementation.',
    ...
    },
    {
      ...
      description: 'Django JWT implementation, analytics development, comprehensive API documentation, and budget logic optimization.',
  ...
  return (
    <div className="min-h-screen bg-background">
      ...
      {/* About Section */}
      <section id="about" className={`py-20 bg-gradient-section ${isVisible.about ? 'animate-fade-in' : 'opacity-0'}`}>
      ...
      {/* Skills Section */}
      <section id="skills" className={`py-20 ${isVisible.skills ? 'animate-fade-in' : 'opacity-0'}`}>
        <div className="container mx-auto px-6">
          <div className="max-w-6xl mx-auto">
            <div className="text-center mb-16">
      ...
      {/* Projects Section */}
      <section id="projects" className={`py-20 bg-gradient-section ${isVisible.projects ? 'animate-fade-in' : 'opacity-0'}`}>
        <div className="container mx-auto px-6">
          <div className="max-w-6xl mx-auto">
            <div className="text-center mb-16">
      ...
      {/* Experience Section */}
      <section id="experience" className={`py-20 ${isVisible.experience ? 'animate-fade-in' : 'opacity-0'}`}>
        <div className="container mx-auto px-6">
          <div className="max-w-6xl mx-auto">
            <div className="text-center mb-16">
            ...
            <div className="grid lg:grid-cols-2 gap-12">
              ...
              <div>
                ...
                <div className="space-y-8">
                  <Card className="shadow-card hover:shadow-elegant transition-all duration-300">
                    <CardHeader>
                      <CardTitle className="text-lg">ALX Software Engineering Program</CardTitle>
                      <CardDescription>2024 – 2025</CardDescription>
                    </CardHeader>
                    <CardContent>
                      <p className="text-sm text-muted-foreground leading-relaxed mb-4">
                        Comprehensive full-stack development program covering API engineering, authentication systems, scalable architecture, and Agile methodologies.
                      </p>
                      <div className="flex items-center gap-2 text-primary">
                        <Award className="w-4 h-4" />
                        <span className="text-sm font-medium">Software Engineering Certificate</span>
                      </div>
                    </CardContent>
                  </Card>
                  ...
                  <Card className="shadow-card hover:shadow-elegant transition-all duration-300">
                    <CardHeader>
                      <CardTitle className="text-lg">Bachelor's Degree in Economics</CardTitle>
                      <CardDescription>University of Uyo • 2009 – 2016</CardDescription>
                    </CardHeader>
                    <CardContent>
                      <p className="text-sm text-muted-foreground leading-relaxed mb-4">
                        Strong foundation in analytical thinking, data analysis, and economic modeling, providing valuable perspective for technology solutions.
                      </p>
                      <div className="flex items-center gap-2 text-primary">
                        <Award className="w-4 h-4" />
                        <span className="text-sm font-medium">Bachelor's Degree</span>
                      </div>
                    </CardContent>
                  </Card>
                </div>
      ...
      {/* Contact Section */}
      <section id="contact" className={`py-20 bg-gradient-section ${isVisible.contact ? 'animate-fade-in' : 'opacity-0'}`}>
        <div className="container mx-auto px-6">
                ...
                <div>
                  ...
                  <div className="flex gap-4">
                    ...
                    <Button 
                      variant="outline" 
                      size="icon"
                      onClick={() => window.open('https://github.com/Pinness', '_blank')}
                    >
                    ...
                    <Button 
                      variant="outline" 
                      size="icon"
                      onClick={() => window.open('https://x.com/LadyPiness', '_blank')}
                    >
